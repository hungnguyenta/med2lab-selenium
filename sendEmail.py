...
def sendEmail():
    ...
    from_email = Email("hung.nguyen@med2lab.com")
    ...
    content = Content(
        "text/plain", "Hey, please take a look the scripts testing. We've got some error. Could you try at local to fix then upload the script to retry")
